    ...
    <div class="py-12">
        ...
        <form method="POST" action="{{ route('events.update' ,['event' =>$event->id]) }}">
            ...
            <div>
                ...
                <x-jet-input id="event_name" class="block mt-1 w-full" type="text" name="event_name" value="{{ $event->name }}" required  />
            </div>
            <div class="mt-4">
            ...
            <div class="mt-4">
                    ...
                    <x-jet-input id="max_people" class="block mt-1 w-full" type="number" name="max_people" value="{{ $event->maxpeople }}" required />
                </div>
