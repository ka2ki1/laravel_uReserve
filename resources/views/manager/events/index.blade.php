<x-app-layout>
  ...
  <div class="container px-5 py-4 mx-auto" _msthidden="24">
    ...
    <button onclick="location.href='{{ route('events.past')}}'" class="flex mb-4 ml-auto text-white bg-green-500 border-0 py-2 px-6 focus:outline-none hover:bg-green-600 rounded" _msttexthash="79859" _msthidden="1" _msthash="85">過去のイベント一覧</button>
    <button onclick="location.href='{{ route('events.create')}}'" class="flex mb-4 ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded" _msttexthash="79859" _msthidden="1" _msthash="85">新規登録</button>
    </div>
